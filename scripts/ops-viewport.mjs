...
if (argv.includes("--help") || argv.includes("-h")) {
  console.log(
    [
      ...
      "",
      "  Mäter fem saker vid 390, 768 och 1280 px, på varje rutt:",
      ...
      "    6. sidans bakgrund är en annan färg i mörkt läge",
      "    7. varje reglage är minst 44px högt i den renderade rutan",
      "    8. accentfärgen finns i varje reglages bild, alltså är tumman vår",
      "",
